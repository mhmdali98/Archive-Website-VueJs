...
<div>
  ...
  <ul class="utilities">
    <br>
    <li class="users warn2"><a href="#">My Account</a></li>
...
<nav role='navigation'>
  <ul class="main">
    <router-link to="/Allarch">
    <li class="dashboard"><a href="#">All Archives</a></li>
    </router-link>
    <router-link to="/AddArch">
    <li class="edit"><a href="#">Add Archive</a></li>
    </router-link>
    <router-link to="/Users">
    <li class="users"><a href="#">All Users</a></li>
    </router-link>
    <router-link to="/AddUser">
    <li class="write"><a href="#">Add User</a></li>
    </router-link>
  </ul>
</nav>
...
export default {
   data() {
    ...
    created () {
    axios.get('https://vue-test-10da4.firebaseio.com/users.json')
    .then(res => {
      // console.log(res)
      // const data = res.data
      // const archive = []
      ...
      // }
      // console.log(archive)
      // this.fullName = archive[0].fullName1
      return res;
    })
    .then(data =>{
      const result = []
